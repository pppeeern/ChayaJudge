...
export default function RightSideBar({ comp }: any) {
  return (
    <div className="h-full border-l border-l-gray-300">
      <div className="sticky top-0 flex flex-col gap-4 pt-4 h-[calc(100vh-3.5rem)]">
        ...
        <ScoreSection
          ...
          has_dis={comp.has_disqualify}
        />
        <Divider />
        <TimeSection max_time={comp.max_time} />
        <Divider />
...
function Divider() {
  return <div className="w-full border-b border-b-gray-300 my-1"></div>;
}
